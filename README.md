...
The project currently has a minimal LangGraph agent with PostgreSQL order lookup, support-ticket creation, human-approved order cancellation, and local policy retrieval from fictional Markdown documents through a persistent Chroma index.
